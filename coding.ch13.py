...
def ch13(username, password, verbose = False):
	if verbose: 
		_tsout('logging')
	s = requests.Session()
	...
	if verbose:
		_tsout('solved: ' + msg_hash)
	
	if verbose:
		_tsout('submitting solution')
	r = s.get(URL + '/challenges/13/' + msg_hash)
...
if __name__ == '__main__':
	...
	ch13(username, password, VERBOSE)
	sys.exit(0);
